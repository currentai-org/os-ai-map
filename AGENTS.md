...
- **Adding a product touches four files**: product, score, category roster, org roster. The
  long-tail counts and the corpus goldens are derived or bot-regenerated on merge.
