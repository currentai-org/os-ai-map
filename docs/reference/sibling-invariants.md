...
| method words a provenance line may not name | retired with the `comments` verification line (#619); no module may redefine it | none | `test_the_method_vocabulary_is_not_redefined_now_that_its_owner_is_gone` |
