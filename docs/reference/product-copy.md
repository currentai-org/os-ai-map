...
channel", "star-based reading", "rests on", and any construction where a subject and verb would
have done. Preserve every fact; rewrite every sentence that sounds like it was generated by
