...
```text
deployed tables in the in-scope datasets    <!-- count:deployed_tables -->63
staged, not deployed                         <!-- count:staged_assets -->6
dormant, no platform table yet              <!-- count:dormant_assets -->1
                                            ------
logical assets in warehouse/assets.yaml     <!-- count:assets -->70
```
...
warehouse/ tracked files, pre-Phase-0   <!-- observed:2026-08-20 -->44
  of which SQL/Python models   <!-- count:model_files -->34   (13 models, 3 ingest, 18 mirror)
