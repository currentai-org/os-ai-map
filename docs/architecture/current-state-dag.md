...
Nodes are the <!-- count:assets -->73 assets in `warehouse/assets.yaml`, plus external upstreams outside the
...
graph LR
  ...
  subgraph registry
    ...
    registry__foundation_model_repos[foundation_model_repos]
