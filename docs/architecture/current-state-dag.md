...
Nodes are the <!-- count:assets -->70 assets in `warehouse/assets.yaml`, plus external upstreams outside the
...
graph LR
  ...
  subgraph observations
    observations__paper_citations[paper_citations]
  ...
  observations__paper_citations --> observations__product_adoption_current
  ...
  registry__product_artifacts --> observations__paper_citations
  ...
  signal_github__artifact_state --> signal_github__product_adoption
  ...
  signal_huggingface__artifact_state --> signal_huggingface__product_adoption
  ...
  class signal_semanticscholar__paper_citations compatibility;
